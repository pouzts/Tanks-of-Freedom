...
func init_root(root_node):
    ...
    self.buildings_blocks = [
		...
		["ROCKET", self.tiles.TERRAIN_ROCKET_FREE, "terrain", self.tiles.TERRAIN_ROCKET_FREE],
    ...
    self.units_blocks = [
		...
		["MEDIC", self.tiles.UNIT_MEDIC_BLUE, "units", 4],
		["INFANTRY", self.tiles.UNIT_INFANTRY_RED, "units", 5],
        ["TANK", self.tiles.UNIT_TANK_RED, "units", 6],
        ["HELI", self.tiles.UNIT_HELICOPTER_RED, "units", 7],
        ["ROCKETEER", self.tiles.UNIT_ROCKETEER_RED, "units", 8],
		["MEDIC", self.tiles.UNIT_MEDIC_RED, "units", 9],
		["CIVILIAN", self.tiles.UNIT_CIVILIAN, "units", 10]
    ]

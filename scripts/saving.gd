...
func _initialize():
    ...
    self.building_map = {
        'none' : [-1, t.TERRAIN_BARRACKS_FREE, t.TERRAIN_FACTORY_FREE, t.TERRAIN_AIRPORT_FREE, t.TERRAIN_TOWER_FREE, t.TERRAIN_ROCKET_FREE, t.TERRAIN_TENT_FREE],
        'red'  : [t.TERRAIN_HQ_RED , t.TERRAIN_BARRACKS_RED, t.TERRAIN_FACTORY_RED, t.TERRAIN_AIRPORT_RED, t.TERRAIN_TOWER_RED, t.TERRAIN_ROCKET_RED, t.TERRAIN_TENT_RED],
        'blue' : [t.TERRAIN_HQ_BLUE , t.TERRAIN_BARRACKS_BLUE, t.TERRAIN_FACTORY_BLUE, t.TERRAIN_AIRPORT_BLUE, t.TERRAIN_TOWER_BLUE, t.TERRAIN_ROCKET_BLUE, t.TERRAIN_TENT_BLUE]
    }

    self.unit_map = {
        0 : [0, 1, 2, 6, 7], # blue units
        1 : [3, 4, 5, 8, 9] # red units
    }

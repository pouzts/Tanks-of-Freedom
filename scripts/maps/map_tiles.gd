...
const TERRAIN_ROCKET_FREE = 35
const TERRAIN_ROCKET_BLUE = 36
const TERRAIN_ROCKET_RED = 37

const TERRAIN_TENT_FREE = 38
const TERRAIN_TENT_BLUE = 39
const TERRAIN_TENT_RED = 40

const UNIT_ROCKETEER_BLUE = 41
const UNIT_ROCKETEER_RED = 42

const UNIT_MEDIC_BLUE = 43
const UNIT_MEDIC_RED = 44

const UNIT_CIVILIAN = 45
